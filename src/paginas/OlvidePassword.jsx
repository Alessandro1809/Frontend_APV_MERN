...
export const OlvidePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (emailLimpio === "" || emailLimpio.length < 6) {
    ...
    <>
      ...
      <div className="px-5 py-10 mt-20 bg-white shadow-lg md:mt-5 rounded-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            type="submit"
            value="Enviar mail de recuperacion"
            className="w-full px-10 py-3 mt-5 font-bold text-white uppercase bg-indigo-700 rounded-xl hover:cursor-pointer hover:bg-indigo-500 md:w-full"
          />
        </form>
        ...
        <nav className="mt-10 lg:flex lg:justify-between">
          ...
          <Link className="block my-5 text-center text-gray-500" to="/registrar">
            ¿No tienes una cuenta aún? Registrate gratis
          </Link>
        </nav>
      </div>
    </>
